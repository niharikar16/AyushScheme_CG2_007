...
class GuestModeMaps extends StatefulWidget {
  const GuestModeMaps({Key? key}) : super(key: key);

  @override
  _GuestModeMapsState createState() => _GuestModeMapsState();
}

class _GuestModeMapsState extends State<GuestModeMaps> {
              ...
              showDialog(
                ...
                builder: (BuildContext context) {
                  return AlertDialog(
                    ...
                    content: Text("You are a guest user! Login to access the functionalities"),
                    actions: <Widget>[
                      TextButton(
                        onPressed: () {
                          // Close the dialog
                      ...
                      TextButton(
                        onPressed: () {
                          // Close the dialog
                          Navigator.of(context).pop();
                          // Continue as guest, perform desired action
                        },
